...
export class SshClient extends Client {
    ...
    public startConnection(operation?: Function, options?: IOption) {
        this.on('ready', () => {
    ...
    public sFtpOperation(remotePath: string, localPath: string, type: SFTPType, operation?: Function, options?: IOption) {
    ...
    public callShell(cmd: string, operation?: Function, options?: IOption) {
